...
public class ActorCriteriaPanel extends JPanel implements CriteriaPanel {
	...
	public ActorCriteriaPanel() {
		...
		JLabel lblTitreDuFilm = new JLabel("Acteur:");
		...
		btnSupprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Container parent = ActorCriteriaPanel.this.getParent();
				parent.remove(ActorCriteriaPanel.this);
				parent.revalidate();
			}
		});
